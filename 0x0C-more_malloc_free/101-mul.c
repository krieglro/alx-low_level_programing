...
/**
 * find_len - returns the length of a stirng
 * @str: the string that is measured
 ...
 * Return: returns a pointer to the next ellements that is not a 0
 */
char *iterate_zeroes(char *str)
{
	while (*str && *str == '0')
 ...
 * Description: given c is not a digit function exits status 98
 ...
 * @digit: single digit
 * @zeroes: necessary number of zeros leading
 * Description: if mult contains a non digit exits
 */
void get_prod(char *prod, char *mult, int digit, int zeroes)
{
